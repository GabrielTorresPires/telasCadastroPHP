    ...
    <div class="row" style=" margin-top: 100px;"> 
      ...
      <div class="row">
        <div class="col-12 espaco">
          <input type="text" name="nome" class="form-control" placeholder="Nome do Fornecedor" aria-label="Nome do cliente">
        </div>
        <div class="col-10 espaco">
          <input type="text" name="cep" id="cep" class="form-control" placeholder="CEP" aria-label="CEP">
        </div>
        <div class="col-2 espaco">
          <input type="text" name="estado" id="estado" class="form-control" placeholder="Estado" aria-label="Estado">
        </div>
        ...
        <div class="col-6 espaco">
          <input type="text" name="rg" id="rg" class="form-control" placeholder="RG" aria-label="RG">
        </div>
        <div class="col-6 espaco">
